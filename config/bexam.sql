...
CREATE TABLE IF NOT EXISTS `exam_question`  (
  `question_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '试题ID',
  ...
  `usage_count` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '组卷次数',
  `question_point_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '知识点ID',
...
-- ----------------------------
-- Table structure for exam_score_student
-- ----------------------------
DROP TABLE IF EXISTS `exam_score_student`;
CREATE TABLE `exam_score_student`  (
...
-- ----------------------------
-- Table structure for exam_score_class
-- ----------------------------
DROP TABLE IF EXISTS `exam_score_class`;
CREATE TABLE `exam_score_class`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `paper_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '试卷ID',
  `class_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '班级ID',
