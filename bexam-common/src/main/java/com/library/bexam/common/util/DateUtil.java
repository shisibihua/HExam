...
public class DateUtil {
 ...
 SimpleDateFormat timeShortFormat = new SimpleDateFormat(
    ...
    /**
     * 将日期格式转换成GMT，格式:Mon Dec 24 2018 13:51:17 GMT+0800
     * @param date
     * @return
     */
    public static String convertDateToGMT(Date date){
        SimpleDateFormat gmtSdf = new SimpleDateFormat(
                "EEE MMM dd yyyy HH:mm:ss 'GMT'Z", new Locale("ENGLISH", "CHINA"));
        return gmtSdf.format(date);
    }
    /**
     * 将日期格式的字符串转换成GMT，格式:Mon Dec 24 2018 13:51:17 GMT+0800
     * @param dateTime  格式：yyyy-MM-dd HH:mm:ss
     * @return
     */
    public static String convertDateToGMT(String dateTime){
        SimpleDateFormat gmtSdf = new SimpleDateFormat(
                "EEE MMM dd yyyy HH:mm:ss 'GMT'Z", new Locale("ENGLISH", "CHINA"));
        return gmtSdf.format(parseDatetime(dateTime));
    }
